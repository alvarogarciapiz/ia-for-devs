            ...
            tools: [
                {
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            path: {
                                type: 'string',
                                description: 'Ruta absoluta del fichero a subir (ejemplo: /Users/user/Desktop/a.txt)',
                            },
                        },
                        required: ['path'],
                    },
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (!args.path) {
                throw new McpError(
                    ...
                    'Falta el parámetro requerido: path del fichero a subir'
                );
            }
            ...
            try {
                ...
                if (!url) {
                    throw new McpError(
                        ...
                        'No se pudo obtener la URL del archivo subido'
                    );
                }
                return {
                    content: [
                ...
                throw new McpError(
                    ErrorCode.InternalError,
                    `Error subiendo el fichero: ${error.message || error}`
                );
            }
        });
    }
